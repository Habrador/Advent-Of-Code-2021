...
public class Day_17 : MonoBehaviour
{
    ...
    private void Part_1()
    {
        ...
        foreach (int xVel in xTestVelocities)
        {
            foreach (int yVel in yTestVelocities)
            {
                ...
                FireProbe(vel, maxTargetRange, minTargetRange, out bool hitTarget, out int maxYThisLaunch);
    ...
    private void FireProbe(Vector2Int currentVel, Vector2Int maxTargetRange, Vector2Int minTargetRange, out bool hitTarget, out int maxY)
    {
